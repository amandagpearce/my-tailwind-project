...
export const VALIDATOR_REQUIRE = (): { type: string } => ({
  type: VALIDATOR_TYPE_REQUIRE,
});
export const VALIDATOR_FILE = (): { type: string } => ({
...
export const VALIDATOR_MIN = (val: number): { type: string, val: number } => ({
  type: VALIDATOR_TYPE_MIN,
  val: val,
});
export const VALIDATOR_MAX = (val: number): { type: string, val: number } => ({
  type: VALIDATOR_TYPE_MAX,
  val: val,
});
export const VALIDATOR_EMAIL = (): { type: string } => ({
  type: VALIDATOR_TYPE_EMAIL,
});

export const validate = (value: string, validators: any[]): boolean => {
  let isValid = true;
